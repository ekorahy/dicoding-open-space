 ...
 *   - should return the talks with the new talk whwn given by ADD_TALK action
 *   - should return the talks with the toogled like like talk when
 *  given by TOGGLE_LIKE_TALK action * */
